...
// Separando tipos de entrada
	...
	<?php if(get_post_type( get_the_ID() ) ==  'tvshows') { get_template_part('inc/parts/modules/episodes'); } ?>
	<?php if(get_post_type( get_the_ID() ) ==  'seasons') { get_template_part('inc/parts/modules/episodes'); } ?>
