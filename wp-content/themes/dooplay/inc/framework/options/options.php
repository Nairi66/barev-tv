...
array(
    ...
    "display_checkbox_id" => "toggle_checkbox_id",
    "options" => array(
		"white" => __('White style','mtms'),
		"dark" => __('Dark style','mtms')
	),
...
array(
    ...
    "id" => array("dt_emoji_disable","dt_toolbar_disable","dt_register_user"), 
    "options" => array( __('Emoji disable','mtms'), __('User toolbar disable','mtms'), __('Allow user register','mtms') ), 
...
array(
	...
	"under_section" => "general", 
    "type" => "pages", 
    "name" => __('My favorites','mtms'), 
    "display_checkbox_id" => "toggle_checkbox_id",
    "id" => "dt_favorites_page", 
    "desc" => __('Select relevant page','mtms'),
),
array(
	// dt_contac_page
...
array(
    ...
    "desc" => __("Add modular Shortcodes and configure your home page<br> <a href=\"http://nullrefer.com/?https://doothemes.com/forums/topic/12-homepage-modular/\" target=\"_blank\">more info</a>","mtms"),
	"rows" => "7",
    "code" => "[module-slider]
