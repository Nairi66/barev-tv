...
function dtdirector() {
	...
	register_taxonomy( 'dtdirector', array( 'movies','episodes' ), $args );
}
...
// Guest Star
function dtgueststar() {
	$labels = array(
		'name'                       => __( 'Guest Star', 'mtms' ),
		'singular_name'              => __( 'Guest Star', 'mtms' ),
		'menu_name'                  => __( 'Guest Star', 'mtms' ),
	);
	$rewrite = array(
		'slug'                       => get_option('dt_gueststar_slug','guest-star'),
		'with_front'                 => true,
		'hierarchical'               => false,
	);
	$args = array(
	...
	register_taxonomy( 'dtgueststar', array( 'episodes' ), $args );
}
add_action( 'init', 'dtgueststar', 0 );
