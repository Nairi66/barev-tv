...
<h3>License Doothemes</h3>
	...
	<tbody>
		<tr>
		<td>
			<input id="<?php echo $this->theme_slug; ?>_license_key" name="<?php echo $this->theme_slug; ?>_license_key" type="text" class="regular-text mttext" value="Nulled-by-fire2000" placeholder="<?php _e('License','mtms') ; ?>" Readonly/>
