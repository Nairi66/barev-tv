...
<div class="account">
	<div class="sidebar">
		<ul>
			<li><a <?php echo $_GET['action'] == '' ? 'class="active"' : ''; ?> href="<?php the_permalink(); ?>">My account</a></li>
			<li><a <?php echo $_GET['action'] == 'edit' ? 'class="active"' : ''; ?> href="<?php the_permalink(); ?>?action=edit">Edit account</a></li>
			<li><a <?php echo $_GET['action'] == 'list' ? 'class="active"' : ''; ?> href="<?php the_permalink(); ?>?action=list">My list</a></li>
			<li><a <?php echo $_GET['action'] == 'list-movies' ? 'class="active"' : ''; ?> href="<?php the_permalink(); ?>?action=list-movies">My movies</a></li>
			<li><a <?php echo $_GET['action'] == 'list-tv' ? 'class="active"' : ''; ?> href="<?php the_permalink(); ?>?action=list-tv">My tv shows</a></li>
		</ul>
	</div>
	...
	<div class="content">
		...
		<form method="post" class="update_profile" action="<?php the_permalink(); ?>?action=edit">
			...
			<fieldset class="form-submit">
				<input name="updateuser" type="submit" id="updateuser" class="submit button" value="<?php _e('Update account', 'profile'); ?>" />
