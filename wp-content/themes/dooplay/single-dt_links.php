...
<div id="single">
	<div class="links">
		<div class="aa">
			<div class="ads_300"><img src="http://blog.adroll.com/content/static_300x250_v001_0511121.jpg"></div>
		</div>
		<div class="bb">
			<h1><?php echo $tipo, ' - ', $title, ' (', $calidad, ')'; ?></h1>
			 <div class="ads_468"><img src="http://youtuber.thumka.net/butn1.png"></div>
